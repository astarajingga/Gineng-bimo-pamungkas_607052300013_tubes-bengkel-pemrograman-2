...
<html lang="en">
    ...
    <body>
        ...
        <!-- Your JavaScript for counting items and updating notification -->
        <script>
            function hitungJumlahBarang() {
                // Logika untuk menghitung jumlah barang
                return jumlahBarang;
            }

            function updateNotifikasi() {
                var itemCount = hitungJumlahBarang();
                var cartItemCount = document.getElementById('cart-item-count');
                cartItemCount.textContent = itemCount;
            }

            // Panggil fungsi untuk memperbarui notifikasi saat halaman dimuat
            updateNotifikasi();
        </script>
